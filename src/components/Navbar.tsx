      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "px-6 py-3" : "px-0 py-0"}`}>
        <div className={`mx-auto relative flex items-center justify-between transition-all duration-500 bg-white
                ...
                <div className="absolute top-[calc(100%+10px)] left-1/2 -translate-x-1/2 w-[860px] bg-white rounded-2xl shadow-2xl border border-gray-100 p-5"
                  ...
                  <div className="grid grid-cols-4 gap-0">
                    ...
                    <div className="bg-brand rounded-xl p-4">
                      ...
                      {CORE_SERVICES.map((s) => (
                        <Link key={s.id} href={s.href} onClick={() => setMegaOpen(false)}
                ...
                <div className="absolute top-[calc(100%+10px)] left-0 w-[280px] bg-white rounded-3xl shadow-2xl border border-gray-100 p-4"
                  ...
                  <div className="space-y-4">
                    <div className="rounded-3xl bg-gray-50 p-4">
                      ...
                      <Link href="/about" onClick={() => setCompanyOpen(false)} className="block text-sm font-semibold text-gray-900 hover:text-brand transition-colors">About</Link>
          ...
          <div className="hidden md:flex">
            <Link href="/contact" className="flex items-center gap-1.5 bg-brand text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-brand-dark transition-all shadow-md shadow-brand/30 hover:scale-[1.02]">
              Get in touch
            </Link>
          </div>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 bg-white pt-20 px-6 overflow-y-auto">
          <div className="flex flex-col gap-2 mt-4">
            ...
            <Link href="/about" onClick={() => setMobileOpen(false)} className="px-4 py-3 rounded-xl bg-gray-50 text-sm font-medium text-gray-700">About</Link>
